...
if __name__ == "__main__":
    ...
    def reward_metric(rews):
        agent_rewards = []
        for agent_idx in range(rews.shape[1]):
            agent_rewards.append(rews[:, agent_idx])
    ...
    result = offpolicy_trainer(
        ...
        max_epoch=100,
        step_per_epoch=500,
        step_per_collect=100,  # Increase this value to collect more episodes before updating the policy
        episode_per_test=5,
        batch_size=64,
        train_fn=train_fn,
        test_fn=test_fn,
